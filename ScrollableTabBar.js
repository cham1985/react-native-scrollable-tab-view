...
const ScrollableTabBar = createReactClass({
  ...
  getDefaultProps () {
    return {
      ...
      tabStyle: {},
      tabsContainerStyle: {},
      underlineStyle: {}, showUnderline: true,
    }
  },
  ...
  renderTab (name, page, isTabActive, onPressHandler, onLayoutHandler) {
    const { activeTextColor, inactiveTextColor, textStyle, renderTabView } = this.props
    ...
    >
      ...
      >
        ...
        >
          ...
          {this.props.showUnderline && <Animated.View style={[tabUnderlineStyle, dynamicTabUnderline, this.props.underlineStyle,]} />}
        </View>
      </ScrollView>
    </View>
  },
